...
city = "Кременчуг"
date = '2019-02-04'
url_for_city = requests.get('https://sinoptik.ua/погода-{}/{}'.format(city, date)).text
...
# Добавляем в список ветер и облачность
    ...
    parameters_of_weather.append(soup.find('div', class_="Tooltip wind wind-S")['data-tooltip'])
